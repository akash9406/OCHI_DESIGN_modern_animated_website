const Footer = () => {
  return (
    <div
      ...
      className=" w-full h-screen flex px-10 py-10 "
    >
      <div className="h-full w-1/2 font-['Founders Grotesk X-Cond'] flex flex-col justify-between">
        <h1 className="text-[14vh] leading-none tracking-tighter font-bold">
          EYE-
          <br /> OPENING
        </h1>
        <div className="pl-2">
      ...
      <div className="h-full w-1/2   font-['Founders Grotesk X-Cond'] flex flex-col  gap-8">
        <div>
          <h1 className="text-[14vh] leading-none tracking-tighter font-bold">
            PRESENTATIONS
          </h1>
        ...
        <div className="px-16">
          <h1>Email:</h1>
          <a href="#"> Hello@ochi.designs</a>
        </div>
        <div className="flex justify-between px-16 mt-[25vh]">
          <h1 className="text-gray-400">© ochi design 2024. Legal Terms</h1>
          <h1 className="text-gray-400">Website by Obys</h1>
        </div>
      </div>
    </div>
  );
